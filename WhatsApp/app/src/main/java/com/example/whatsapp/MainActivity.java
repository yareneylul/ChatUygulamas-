...
public class MainActivity extends AppCompatActivity {
    ...
    private void RequestNewGroup() {
        ...
        groupNameField.setHint("e.g Parlayan Yıldızlar Takımı");
        ...
        builder.setPositiveButton("Oluştur", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                {
                    Toast.makeText(MainActivity.this, "Grup Adını Giriniz", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        RootRef.child("Groups").child(groupName).setValue("")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(MainActivity.this, groupName + " grup başarıyle oluşturuldu.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
